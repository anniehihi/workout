<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div
      ...
      class="mb-10 p-4 rounded-md shadow-md bg-gray-200"
    >
    ...
    <div v-if="dataLoaded">
      ...
      <div
        class="flex flex-col items-center p-8 rounded-md shadow-md bg-gray-200 relative"
      >
        <div v-if="user" class="flex absolute left-2 top-2 gap-x-2">
          <div
            class="h-7 w-7 rounded-full flex justify-center items-center cursor-pointer bg-green-500 shadow-lg"
            @click="editMode"
          >
            <img
              class="h-3.5 w-auto"
        ...
        <span
          class="mt-6 py-1.5 px-5 text-xs text-white bg-green-500 rounded-lg shadow-md"
        >
          {{ data.workoutType }}
        </span>
        ...
        <div class="w-full mt-6">
          ...
          />
          <h1 v-else class="text-green-500 text-2xl text-center">
            {{ data.workoutName }}
          </h1>
        </div>
      </div>
      ...
      <!-- Exercises -->
      <div
        class="mt-10 p-8 rounded-md flex flex-col item-center bg-gray-200 shadow-md"
      >
        <!-- Strength Training -->
        <div
        ...
        >
          ...
          <button
            ...
            @click="addExercise"
            type="button"
            class="py-2 px-6 rounded-sm self-start text-sm text-white bg-green-500 duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-green-500"
          >
            Add Exercise
          </button>
        </div>
        ...
        <div v-else class="flex flex-col gap-y-4 w-full">
          ...
          >
            <div class="flex flex-2 flex-col md:w-1/3">
              <label for="cardioType" class="mb-1 text-sm text-green-500">
                Type
              </label>
              <select
                id="cardioType"
      ...
      <button
        ...
        @click="update"
        type="button"
        class="mt-10 py-2 px-6 rounded-sm self-start text-sm text-white bg-green-500 duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-green-500"
      >
        Update Workout
      </button>
    </div>
